package com.mirs.view0.registercustomerjframe;
...
import com.mirs.view0.MessageDialog;
import com.mirs.view0.Utils;
        ...
        implements ActionListener 
{
 ...
 private void ok_actionPerformed(ActionEvent event) {
  User user = registerCustomerJFrame.getSelectedData();
    
     Composite rentalComposite = new Composite();
     rentalComposite.setUser(user);
     
 	 InstrumentRentalManager instrumentRentalManager = InstrumentRentalManager.getInstance();
 	 if (instrumentRentalManager != null)
 	 {	 
	 	 boolean action =  instrumentRentalManager.performAction("RegisterCustomer", rentalComposite);
